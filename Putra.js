...
`
        ...
        break;
			...
			case 'blur':
              ...
              contentText:`Follow Tiktok @putragans644`,buttons,headerType:4}
              prep = await Putra.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              Putra.relayWAMessage(prep)
              ...
              buttonsMessage = {footerText:'crated by Putra Store', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow Tiktok @Putragans644`,buttons,headerType:4}
              prep = await Putra.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftoko})
              Putra.relayWAMessage(prep)
...
`
 ...
 Putra Store︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`allmenu`,`runtime`,`status`,`groupmenu`,`nekopoimenu`,`dosamenu`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcmikel`,`sewabot`,`info`,`store`,`patner`,]
