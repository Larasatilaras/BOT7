...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        ////DAFTAR BUTTON 
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Putra Bot ミケルVerify Terlebih Dahulu Ya `
       const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Kak\nUntuk Wa Gb Silahkan ketik .verify```'
       const daftar3 = [
          {
            buttonId: `!verify`,
            buttonText: {
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6283842942635`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break*/
               case 'spamcall':{
...
𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰𝔢𝔬𝔯𝔞𝔫𝔤 
  𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔪𝔞𝔰𝔞𝔩𝔞𝔩𝔲𝔫𝔶𝔞`
Putra.sendMessage(from, { contentText: `${menuny}`, footerText: 'By Putra Ganzz', buttons: [{ buttonId: `!command`, buttonText: { displayText: 'LIST MESSAGE' }, type: 1 },{ buttonId: `!tq`, buttonText: { displayText: '🌹 THANKS TO' }, type: 1 },{ buttonId: `!patner`, buttonText: { displayText: '👥 PATNER' }, type: 1 } ],  headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break 
...
`
        ...
        break;
			...
			case 'blur':
              ...
              imageMsg = (await Putra.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by Putra Store', imageMessage: imageMsg,
...
break
              ...
              Putra.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await Putra.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'created By Putra Store', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow Ig @putragans167`,buttons,headerType:4}
              prep = await Putra.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              Putra.relayWAMessage(prep)
                    break
              ...
              Putra.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
             buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/wetglass?apikey=${setting.lolkey}&text=${ini_txt}`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await Putra.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'crated by Putra Store', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow Ig @putragans167`,buttons,headerType:4}
...
`
 ...
 Putra Store︎`, imageMessage: imageMsg,
      ...
      case 'command':
               list = []
               listmenu = [`allmenu`,`runtime`,`status`,`groupmenu`,`nekopoimenu`,`dosamenu`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcmikel`,`sewabot`,`info`,`patner`,]
               listmenuu = [`All Menu Bot`,`Runtime`,`Status Bot`,`Menu Group`,`Nekopoi Menu`,`Dosa Menu`,`Photo Oky`,`Image Maker`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`18+ Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`,`Thanks To`,`Patner Bot`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'menu ke' + nombor++,
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1}]
       ...
       case 'sc': 
       case 'src':
              reply("Bot Ini Menggunakan Script :\nhttps://github.com/Putragans9/BOT7")
              break
